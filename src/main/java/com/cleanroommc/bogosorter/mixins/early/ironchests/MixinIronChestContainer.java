package com.cleanroommc.bogosorter.mixins.early.ironchests;// package com.cleanroommc.bogosorter.mixins.early.ironchests;
//
...
// builder.addSlotGroup(0, type.size, type.getRowLength())
