...
public class ClientEventHandler {
    ...
    public static final KeyBind moveAllSame = KeyBind.builder("moveAllSame")
        .lmb(true)
        .addKeysFromConfig()
        .build();
    public static final KeyBind moveAll = KeyBind.builder("moveAll")
        .lmb(true)
        .addKeysFromConfig()
        .build();
    public static final KeyBind moveSingle = KeyBind.builder("moveSingle")
        .lmb(true)
        .addKeysFromConfig()
        .build();
    public static final KeyBind moveSingleEmpty = KeyBind.builder("moveSingle")
        .rmb(true)
        .addKeysFromConfig()
        .build();
    public static final KeyBind throwAllSame = KeyBind.builder("moveAllSame")
        .addKeysFromConfig()
        .validator(() -> isKeyDown(Minecraft.getMinecraft().gameSettings.keyBindDrop))
        .build();
    public static final KeyBind throwAll = KeyBind.builder("moveAll")
        .addKeysFromConfig()
        .validator(() -> isKeyDown(Minecraft.getMinecraft().gameSettings.keyBindDrop))
        .build();
