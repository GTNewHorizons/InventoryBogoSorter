...
public class DefaultProviderImpl implements DefaultProvider {
    ...
    @Override
    public void balanceGrid(EntityPlayer entityPlayer, Container container, IInventory craftMatrix, int start,
        int size) {
    ...
    @Override
    public ItemStack putIntoGrid(EntityPlayer entityPlayer, Container container, IInventory craftMatrix,
    ...
    @Override
    public boolean transferIntoGrid(EntityPlayer entityPlayer, Container container, IInventory craftMatrix,
        Slot sourceSlot) {
    ...
    @Override
    public void rotateGrid(EntityPlayer entityPlayer, Container container, IInventory craftMatrix, int start, int size,
