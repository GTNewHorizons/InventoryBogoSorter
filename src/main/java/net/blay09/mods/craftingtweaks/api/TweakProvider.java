...
public interface TweakProvider {
     ...
     * @return the slot number within the container's inventorySlots list that marks the beginning of the grid (for
     *         client-only instances)
     */
    int getCraftingGridStart(EntityPlayer entityPlayer, Container container, int id);
     ...
     */
    int getCraftingGridSize(EntityPlayer entityPlayer, Container container, int id);
