...
public interface DefaultProviderV2 {
     ...
     * @param id               the crafting grid id invoking this function (usually 0 unless the container has multiple
     *                         grids)
     ...
     * @param container    the container the grid is part of
     * @param phantomItems true if the grid contains phantom items (i.e. they should be deleted, not put into the
     *                     player's inventory)
     ...
     */
    ItemStack putIntoGrid(TweakProvider provider, int id, EntityPlayer entityPlayer, Container container,
     ...
     */
    boolean transferIntoGrid(TweakProvider provider, int id, EntityPlayer entityPlayer, Container container,
        Slot sourceSlot);
